<?php
  ...
  $private_file="../llaves/myCert.key";
  $public_file="../llaves/myCert.cer";
  ...
  openssl_sign($cadenaOriginal, $Firma, $private_key, OPENSSL_ALGO_SHA256);
  ...
  if ($result == 1) {
  $correcto = "La firma es válida";
	} else {
  $incorrecto = "La firma no es válida";
  }
